...
Each Leyline runtime adds the goal, memory, and subagent extensions through pi resource loading. Leyline prefers its bundled goal and memory commands when a global extension registers the same command.
